/*	$NetBSD: eay_dss_link.c,v 1.1.1.1.4.1 1999/12/27 18:27:29 wrstuden Exp $	*/

#ifdef EAY_DSS
static const char rcsid[] = "$Header: /home/joerg/repo/netbsd/src/dist/bind/lib/dst/Attic/eay_dss_link.c,v 1.1.1.1.4.1 1999/12/27 18:27:29 wrstuden Exp $";
